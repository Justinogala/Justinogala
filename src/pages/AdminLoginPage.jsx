...
const AdminLoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      {/* Left Panel — Branding */}
      <div className="hidden lg:flex lg:w-[45%] relative bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex-col justify-between p-10 overflow-hidden">
        {/* Decorative grid */}
        ...
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full bg-violet-600/10 blur-[80px] pointer-events-none" />
        ...
        <div className="z-10 space-y-8 -mt-10">
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <div key={label} className="flex items-center gap-1.5 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-3 py-1.5">
