...
import { 
  ...
  Clock, Bell, CreditCard, Building2
} from 'lucide-react';
...
const featuresList = [
  ...
  // Communication
  { icon: MessageSquare, title: "Team Messaging", desc: "Real-time messaging within workspaces. File sharing, reactions, and threaded conversations for seamless communication.", link: "/features/chat-messaging", color: "text-green-500", bg: "bg-green-100 dark:bg-green-900/20" },
  { icon: Bell, title: "Smart Notifications", desc: "Push notifications for shift reminders, messages, and important updates. Customize your notification preferences.", link: "/features/meetings", color: "text-orange-500", bg: "bg-orange-100 dark:bg-orange-900/20" },
  ...
  { icon: Video, title: "Video Meetings", desc: "One-click instant video meetings with WebRTC. Screen sharing, recording, and real-time collaboration.", link: "/features/video-conferencing", color: "text-pink-500", bg: "bg-pink-100 dark:bg-pink-900/20" },
  ...
  { icon: Film, title: "Text to Video", desc: "Generate stunning AI videos from text descriptions using Sora 2. Create clips from 4 to 60 seconds.", link: "/text-to-video", color: "text-fuchsia-500", bg: "bg-fuchsia-100 dark:bg-fuchsia-900/20", badge: "NEW" },
