...
const LegalSolutionPage = () => (
  <SolutionPage
    ...
    faqs={[
      ...
      { q: "Can Munal AI transcribe client meetings and depositions?", a: "Yes. Munal AI uses OpenAI Whisper for real-time transcription and GPT-5.5 for automatic summaries. It extracts key points, action items, and case-relevant decisions from client consultations, depositions, and internal meetings." },
