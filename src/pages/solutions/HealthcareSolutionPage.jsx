...
const HealthcareSolutionPage = () => (
  <SolutionPage
    ...
    features={[
      { icon: Brain, title: "AI Meeting Summaries for Clinical Leadership", description: "Automatically transcribe and summarize clinical and administrative meetings with GPT-5.5. Extract action items, decisions, and follow-ups to keep leadership aligned across departments." },
    ...
    faqs={[
      ...
      { q: "Can Munal AI transcribe and summarize clinical meetings?", a: "Yes. Munal AI uses OpenAI Whisper for real-time meeting transcription and GPT-5.5 for automatic summaries. It extracts action items, decisions, and follow-ups — making it ideal for clinical and administrative leadership alignment meetings." },
