                ...
                >
                  ...
                  <div className="mt-12">
                     <div className="flex gap-4">
                       ...
                       <a href="https://www.linkedin.com/in/justin-ogala/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/20 hover:bg-white/30 transition-colors cursor-pointer flex items-center justify-center" data-testid="contact-linkedin">
