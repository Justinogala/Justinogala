        ...
        <ScrollArea className="h-[65vh] px-6 py-4">
          <div className="prose prose-sm dark:prose-invert prose-slate max-w-none text-sm leading-relaxed space-y-6">
            ...
            <p className="text-slate-600 dark:text-slate-300">
              These Terms of Service (the &ldquo;Terms&rdquo;) are an agreement between (a) a User and (b) Jiffix Inc (&ldquo;Jiffix&rdquo;), the company powering Munal AI, that governs access to and use of the Munal AI eSignature service (&ldquo;Service&rdquo;) by Senders and Recipients. A User means either a Sender or a Recipient as further described in these Terms.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-600 dark:text-slate-300">
              ...
              <li>Recipient&rsquo;s use of the Service is only possible due to Sender&rsquo;s subscription under which Sender acquired a license for the Services from Jiffix Inc. Recipient acknowledges and consents with the terms of the Munal AI Privacy Statement, which describes the types of data that Jiffix Inc collects from Recipient and Recipient&rsquo;s devices, how Jiffix Inc uses Recipient&rsquo;s data, and the legal bases Jiffix Inc has to process such data; as well as how Jiffix Inc uses Recipient&rsquo;s content, which includes content contained within communications with others via the Services.</li>
            </ul>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              ...
              <li>The Service is intended only for use with Contracts that accept &ldquo;simple&rdquo; signatures as defined under applicable law including, but not limited to, the Regulation (EU) No 910/2014 (the eIDAS Regulation), and that are subject to or governed by the laws of applicable jurisdictions. The electronic signatures utilized within this Service do not classify as &ldquo;advanced electronic signatures&rdquo;, &ldquo;qualified electronic signatures,&rdquo; or similar types of signatures as defined under applicable law (such as the eIDAS Regulation). Users are responsible for the collection and preservation of documents and materials that substantiate and prove the due execution of the relevant documents and shall assume and undertake the relevant risks and liabilities.</li>
              <li>Users are responsible for obtaining independent legal advice regarding any Contract prior to sending (as a Sender) or signing (as a Recipient) such Contract. Users are responsible for ensuring (a) that the content of any Contract that a User sends or receives through the Service is accurate, binding, legally enforceable or fit-for-purpose; (b) the sufficiency of the Contract for the transaction between Sender and other Recipients to the Contract; (c) the Contract&rsquo;s compliance with applicable law; and (d) the appropriateness of using the Service to send, receive or electronically sign such Contract, including the use of simple signatures as defined under applicable law. The Service may not be suitable for use with all Contracts, including those that do not accept simple signatures as defined under applicable law.</li>
              <li>Jiffix Inc does not endorse, support, or guarantee the accuracy, completeness, performance, or legality of any Contract, including, for clarity, that such Contract may be entered through the use of electronic documents or electronic signatures. Jiffix Inc does not make any representations, warranties or guarantees that a Recipient&rsquo;s use of the Service, or their electronic signature made to any Contract, will be valid.</li>
              <li>The Service may only be used to facilitate the delivery and/or execution of Contracts between the parties to those Contracts, and may not be used for, or to facilitate, any unlawful or other impermissible transaction or purpose. Nothing in these Terms or the Service may be construed to make Jiffix Inc or any of its affiliates a party to any Contract.</li>
            </ol>
            ...
            <div className="space-y-3 text-slate-600 dark:text-slate-300">
              <div>
                ...
                <p>Sender has exclusive control over and sole responsibility for the content, accuracy, quality, enforceability, and format of any Contract, as well as for determining whether the Contract is of a class or type that may be entered into through use of the Service. Jiffix Inc is not responsible for, and has no control over, a Contract&rsquo;s contents. Jiffix Inc does not review, scan or otherwise access the contents of any Contract and does not obtain any right, title or interest in any Contract, including any intellectual property found within it.</p>
              </div>
              <div>
                <p className="font-medium text-slate-700 dark:text-slate-200">Exceptions.</p>
                <p>Certain types of agreements and documents may be excepted from electronic signature laws, or may be subject to specific regulations regarding electronic signatures and electronic records. Jiffix Inc is not responsible for determining whether any particular Contract (a) is subject to an exception to applicable electronic signature laws; or (b) can be legally formed by electronic signatures or with electronic documents.</p>
              </div>
              <div>
                <p className="font-medium text-slate-700 dark:text-slate-200">Recipients.</p>
                <p>Sender is solely responsible for the accuracy and authenticity of any names and email addresses that it designates as a Recipient to receive a Contract through the Service. Jiffix Inc has no obligation to verify the identity or confirm the accuracy of any Recipient or their name or email address, and has no responsibility or liability to Sender, any Recipient, or other interested party to the Contract, due to your own actions in providing incorrect or inaccurate Recipient information. Jiffix Inc makes no warranty or representation that the name or email address of a Recipient used to sign a Contract actually belongs to the person purported to be bound by the Contract.</p>
              </div>
              <div>
                <p className="font-medium text-slate-700 dark:text-slate-200">Consumer Contracts.</p>
                <p>Certain consumer protection or similar laws or regulations may impose special requirements with respect to electronic contracts involving one or more consumers, such as requirements that the consumer consent to electronic contracting. Jiffix Inc is not responsible for: (a) determining whether any particular Contract involves a consumer for the purpose of such laws or regulations; (b) providing any information or disclosures in connection with any Contract involving a consumer; (c) providing legal review of, or update or correct, any information or disclosures currently or previously given to any consumer; or (d) providing the consumer any copies or access to a Contract pursuant to any legal requirements.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>Once a Contract is delivered to its designated Recipient(s), Sender may request the withdrawal of the Contract prior to all designated Recipients signing the Contract. Jiffix Inc will make commercially reasonable efforts to promptly execute the withdrawal request, however, Jiffix Inc does not guarantee that the withdrawal request will be executed, and the Contract withdrawn, before any or all Recipients sign the Contract. After a Contract is signed by all designated Recipients, the Contract may not be withdrawn through the Service.</p>
              </div>
              <div>
                <p className="font-medium text-slate-700 dark:text-slate-200">Indemnification.</p>
                <p>To the extent permitted by applicable law, Sender will defend, indemnify and hold harmless Jiffix Inc and its affiliates against any third-party claim (including claims made by a Recipient) to the extent such claim (a) arises from Sender&rsquo;s use or election to use the Service in connection with a Contract or Sender&rsquo;s breach of these Terms, or (b) alleges that (i) any Contract submitted to or transmitted by the Service misappropriates a trade secret or directly infringes a patent, copyright, trademark, or other proprietary right of a third party; or (ii) Sender&rsquo;s use of the Service, alone or in combination with anything else, violates law or harms a third party, including such third party&rsquo;s intellectual property rights.</p>
              </div>
            </div>
            ...
            <div className="space-y-3 text-slate-600 dark:text-slate-300">
              ...
              <div>
                ...
                <p>Recipient is solely responsible for confirming the identity of the Sender of a Contract, as well as other Recipients associated with the Contract, if any. Jiffix Inc makes no warranty or representation that the name or email address of the Sender or other Recipients associated with a Contract actually belong to the person(s) purported to be the Sender or Recipient (as applicable), or is bound by the Contract.</p>
              </div>
              <div>
                <p className="font-medium text-slate-700 dark:text-slate-200">Disputes.</p>
                <p>If Recipient disputes any aspect of the Contract, Recipient should not sign the Contract and should address such dispute with the Sender directly. Jiffix Inc is not responsible for the formation or content of any Contract or resolving disputes among parties with respect to the Contract.</p>
              </div>
            </div>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              ...
              <li>
                ...
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  ...
                  <li>install or use non-Jiffix software or technology in any way that would subject Jiffix Inc&rsquo;s intellectual property or technology to any other license terms;</li>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Document Retention.</span> Jiffix Inc is not responsible for determining how long any Contract is required to be retained or stored under any applicable laws, regulations, or legal or administrative agency processes. User is solely responsible for ensuring that it retains a copy of the Contract for any legally required record retention period, and in such form or format as may be required under applicable law.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Availability of Contracts.</span> A Contract will remain available for review and signature until Sender withdraws the Contract, any Recipient declines to electronically sign the Contract, or all Recipients electronically sign the Contract. After a Contract is signed by all Recipients, the Contract will be available to each Recipient for 30 days from the date that Recipients are notified that the Contract has been signed. Each Recipient is responsible for downloading, saving or otherwise retaining a copy of a Contract for its own records. Signed contracts will remain available to Sender through the Munal AI platform in accordance with Sender&rsquo;s agreement with Jiffix Inc and Sender&rsquo;s own document retention configuration.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Deletion.</span> Jiffix Inc reserves the right to suspend access to or delete any Contract if Jiffix Inc reasonably and in good faith suspects or believes that such Contract is for illegal purposes or otherwise could cause any User to be in violation of these Terms. Jiffix Inc will make commercially reasonable efforts to notify Sender prior to such suspension or deletion, unless Jiffix Inc reasonably believes that: (a) it is prohibited from doing so under applicable law or under legal process; or (b) it is necessary to delay notice in order to prevent imminent harm to the Service, Jiffix Inc or its affiliates, or a third party.</li>
            </ol>
            ...
            <p className="text-slate-600 dark:text-slate-300">
              Jiffix Inc warrants that its service will function substantially as described in these Terms. Otherwise and to the extent permitted under applicable law:
            </p>

            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              <li>Jiffix Inc disclaims all express, implied, or statutory warranties and conditions, including warranties and conditions of quality, title, non-infringement, merchantability, and fitness for a particular purpose regarding the Service.</li>
              <li>The Service is provided without charge &ldquo;AS IS,&rdquo; without any warranty or condition. Jiffix Inc makes no warranty or representation as to the quality, safety or fitness for purpose of the Service, or of any Contract (whether delivered, made available or electronically signed through the Service), nor does Jiffix Inc warrant that the operation or use of the Service will be error-free, virus-free or uninterrupted.</li>
              <li>Jiffix Inc takes no responsibility and is not liable for any harm or loss suffered by User as a result of sending or signing a Contract, or relying on information contained in a Contract. If User suffers any loss or harm as a result of signing a Contract, or not signing a Contract, User agrees that it shall have no recourse or claim against Jiffix Inc.</li>
            </ol>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Data Protection and Processing.</span> Jiffix Inc, and its respective agents and subcontractors, will process User Data as provided in these Terms and the Data Protection Addendum (DPA), which is incorporated by reference. Before providing any User Data to Jiffix Inc, User will obtain all required consents from third parties (including Recipients) under applicable privacy and data protection laws.</li>
              <li>In addition to these Terms, User acknowledges and agrees to the terms of the Munal AI Privacy Statement, which describes the types of User Data Jiffix Inc collects from User and User&rsquo;s devices, how Jiffix Inc uses User Data, and the legal bases Jiffix Inc has to process User Data.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Your Privacy Obligations.</span> Jiffix Inc makes no warranty as to the suitability of the Service in regard to User&rsquo;s own privacy obligations with respect to other parties to a Contract. User is solely responsible for its own collection, use and disclosure of information concerning itself and other parties. By using the Service, User represents and warrants that it has obtained all necessary authorizations, consents and permissions to provide information to Jiffix Inc in connection with the Service.</li>
            </ol>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              <li>In no event will Jiffix Inc be liable for direct, indirect, incidental, special, punitive, or consequential damages; loss of revenue, profits, or anticipated savings; or loss of use, loss of business information, or interruption of business, however caused or on any theory of liability, in connection with the Service.</li>
              <li>No limitation or exclusions under these Terms will apply to liability arising out of either User&rsquo;s or Jiffix Inc&rsquo;s (a) confidentiality obligations; (b) indemnification obligations; or (c) violation of the other party&rsquo;s intellectual property rights.</li>
              ...
              <li>Without limiting any of the foregoing, should Jiffix Inc be deemed liable to User, its liability shall be limited to reperformance of the Service or refund of any fee paid for use of the Service from which such liability arose.</li>
            </ol>
            ...
            <p className="text-slate-600 dark:text-slate-300">
              Except as otherwise required by applicable law, when bringing any action arising under these Terms, User and Jiffix Inc each agree to the following: If Jiffix Inc brings the action, the venue will be where User has its principal place of business (for entities) or place of residence (for individuals). If User brings the action, the venue will be the state or federal courts in the jurisdiction where Jiffix Inc maintains its principal place of business. User and Jiffix Inc each consent to personal jurisdiction in the agreed venues and submit to the exclusive jurisdiction of the courts of such venue. This choice of venue does not prevent either User or Jiffix Inc from seeking injunctive relief in any jurisdiction with respect to a violation of intellectual property rights or confidentiality obligations.
            </p>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-slate-600 dark:text-slate-300">
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Modifications.</span> Jiffix Inc may update these Terms from time to time. Changes will apply when they are published on the Service site or made available to Recipients through notice. User accepts revised or additional terms when using the Service. If a User does not agree to changes to these Terms, User must stop using the Service.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Independent Contractors.</span> User and Jiffix Inc are independent contractors. User and Jiffix Inc each may develop products independently without using the other&rsquo;s Confidential Information.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Assignment.</span> Jiffix Inc may assign these Terms to an affiliate. User consents to such assignment to an affiliate or third party, without prior notice, of any rights Jiffix Inc may have under these Terms. Any attempted assignment by User, without Jiffix Inc&rsquo;s prior written approval, will be void.</li>
              ...
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Notices.</span> Jiffix Inc may provide User with information and notices electronically, including by email, through the portal for the Service, or by other electronic means. Notice is given as of the date it is made available by Jiffix Inc.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Applicable Law.</span> Except as otherwise required by applicable law, these Terms will be governed by and construed in accordance with the laws of the applicable jurisdiction. The 1980 United Nations Convention on Contracts for the International Sale of Goods and its related instruments will not apply to these Terms.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Affiliates and Subcontractors.</span> Jiffix Inc may perform its obligations under these Terms through its affiliates and use subcontractors to provide certain services. Jiffix Inc remains responsible for their performance.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Government Procurement Rules.</span> If User is a government entity or is otherwise subject to government procurement requirements, User represents and warrants that (a) it has complied and will comply with all applicable government procurement laws and regulations; (b) it is authorized to enter into these Terms; and (c) these Terms satisfy all applicable procurement requirements.</li>
              <li><span className="font-medium text-slate-700 dark:text-slate-200">Compliance with Trade Laws.</span> The Service may be subject to U.S. and other countries&rsquo; export jurisdictions. User and Jiffix Inc each will comply with all laws and regulations applicable to the import or export of the Service. User will not take any action that causes Jiffix Inc to violate applicable Trade Laws. Jiffix Inc may suspend or terminate these Terms to the extent that Jiffix Inc reasonably believes that performance would cause it to violate Trade Laws or put it at risk of becoming subject to sanctions and penalties under such laws.</li>
            </ol>
