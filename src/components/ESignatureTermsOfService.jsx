          ...
          <div className="prose prose-sm dark:prose-invert prose-slate max-w-none text-sm leading-relaxed space-y-6">
            ...
            <div className="space-y-3 text-slate-600 dark:text-slate-300">
              ...
              <div>
                ...
                <p>Certain types of agreements and documents may be excepted from electronic signature laws under Canadian federal or provincial legislation, or may be subject to specific regulations regarding electronic signatures and electronic records. Jiffix Inc is not responsible for determining whether any particular Contract (a) is subject to an exception under applicable Canadian E-Commerce Laws or other provincial legislation; or (b) can be legally formed by electronic signatures or with electronic documents under Canadian law.</p>
              </div>
              <div>
