...
const UserSidebar = ({ className, onClose, isMobile }) => {
  ...
  const menuItems = [
    ...
    { icon: Video, label: 'Text to Video', path: '/text-to-video', badge: 'NEW', gradient: 'from-rose-500 to-orange-500' },
    { icon: Sparkles, label: 'Music Studio', path: '/music-studio', badge: 'NEW', gradient: 'from-fuchsia-500 to-purple-600' },
