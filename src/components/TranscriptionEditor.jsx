...
import { Save, RotateCcw, RotateCw, ArrowLeft, Brain, FileText } from 'lucide-react';
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-grow flex flex-col">
        <div className="border-b border-gray-200 dark:border-gray-800 px-4">
          <TabsList className="h-12 bg-transparent">
            <TabsTrigger 
              value="editor" 
              className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-indigo-500 rounded-none"
            >
        ...
        <TabsContent value="editor" className="flex-grow flex flex-col m-0 p-0">
          ...
          <CardContent className="flex-grow p-0">
            <Textarea 
              className="w-full h-[600px] md:h-[calc(100vh-350px)] resize-none border-0 p-6 focus-visible:ring-0 text-base leading-relaxed"
              value={text}
        ...
        <TabsContent value="analysis" className="flex-grow m-0 overflow-auto">
